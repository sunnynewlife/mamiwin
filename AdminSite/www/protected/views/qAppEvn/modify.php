			...
			<form id="tab" method="post"  onsubmit="return checkSubmit();">
				<table class="tableApp" style="width:815px;">
					<tr>
						...
						<td><input type="text" maxlength="20" name="EvnName" id="EvnName" value="<?php echo $QEvnItem["EvnName"];?>" class="input-xlarge" required="true" autofocus="true" /></td>
						<td style="width:100px;">活动图片*</td>
						<td><input type="text" maxlength="50" name="FileId" value="<?php echo $QEvnItem["FileId"];?>"  id="FileId" onclick="javascript:selectPics('FileId',false);" class="input-xlarge" autofocus="true" required="true" /></td>
					</tr>
					<tr>
						<td>游戏名称*</td>
						<td><input type="text" maxlength="50" name="AppName" id="AppName" value="<?php echo $QEvnItem["AppName"];?>"  class="input-xlarge" autofocus="true"  required="true"  readonly /></td>
						<td>基础返利*</td>
						<td><input type="text" maxlength="20" name="BaseProrate" id="BaseProrate"  value="<?php echo $QEvnItem["BaseProrate"];?>" class="input-xlarge" autofocus="true" required /> %</td>
					</tr>
					<tr>
						<td>活动类型*</td>
						<td>
					...
					<tr>
						<td>活动时间*</td>
						<td>
							<input type='text' maxlength='20' class='dateInputBind start' name="startDt"  id="startDt" value="<?php echo $QEvnItem["EvnStart"];?>" style="width:80px;" required="true" />
							&nbsp;&nbsp;~&nbsp;&nbsp;
							<input type='text' maxlength='20' class='dateInputBind end' name="endDt" id="endDt" value="<?php echo $QEvnItem["EvnEnd"];?>" style="width:80px;" required="true" />
						</td>
						<td>排列顺序</td>
						<td><input type="text" maxlength="50" name="EvnOrder" id="EvnOrder" value="<?php echo $QEvnItem["EvnOrder"];?>" class="input-xSmall" autofocus="true" style="width:80px;" required="true" /></td>
					</tr>
					<tr>
						<td>上线状态</td>
						<td>
							<select name="Status" class="input-xlarge">
								<option value="1" <?php echo $QEvnItem["Status"]=="1"?" selected ":"" ?>>在线</option>
								<option value="2" <?php echo $QEvnItem["Status"]=="2"?" selected ":"" ?>>白名单可见</option>
								<option value="3" <?php echo $QEvnItem["Status"]=="3"?" selected ":"" ?>>下线</option>
							</select>
						</td>
						<td>测试白名单</td>
						<td><input type="text" maxlength="50000" name="AclList" value="<?php echo $QEvnItem["AclList"];?>" class="input-xlarge" autofocus="true" /></td>
					</tr>
					<tr>
						<td>活动概述*</td>
						<td colspan="3"><input type="text" maxlength="100" name="EvnIntro" value="<?php echo $QEvnItem["EvnIntro"];?>" class="input-xlarge" autofocus="true"  required="true" style="width:600px;" /></td>
					</tr>
					<tr>
						<td>活动描述*</td>
						<td colspan="3"><textarea id="EvnContent" maxlength="20000" name="EvnContent" rows="8" style="width:600px;" class="input-xlarge" required="true" autofocus="true"><?php echo $QEvnItem["EvnContent"];?></textarea></td>
					</tr>
				...
				<table class="tableApp" style="width:950px;">
					<tr>
						...
						<td>
							<input type="text" maxlength="50" name="EvnRandMin" id="EvnRandMin" value="<?php echo $QEvnItem["EvnRandMin"];?>" class="input-xSmall" autofocus="true" style="width:80px;" />
							&nbsp;&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="text" maxlength="50" name="EvnRandMax" id="EvnRandMax" value="<?php echo $QEvnItem["EvnRandMax"];?>" class="input-xSmall" autofocus="true" style="width:80px;" />
						</td>
				...
				<table class="tableApp" style="width:950px;display:<?php echo $QEvnItem["EvnType"]=="1"?"block":"none"; ?>;" id="simpleEvn">
					<tr>
						<td style="width:120px;">人数要求</td>
						<td><input type="text" maxlength="50" name="EvnQty" id="EvnQty" value="<?php echo $QEvnItem["EvnQty"];?>" class="input-xlarge" autofocus="true" style="width:140px;" /></td>
						<td style="width:100px;">活动返利</td>
						<td><input type="text" maxlength="50" name="Prorate" id="Prorate" value="<?php echo $QEvnItem["Prorate"];?>" class="input-xlarge" autofocus="true" style="width:140px;" />&nbsp;&nbsp;%</td>
					</tr>
				</table>
				...
				<input type="hidden" name="AppId" Id="AppId" value="<?php echo $QEvnItem["AppId"];?>" />
...
function addProrateRow(pvQty,pvProrate)
{
	...
	var newRow = "<tr id='tr_"+currentId+"'><td>"+lvNoId+"</td><td><input type='text' maxlength='50' value='"+pvQty+"' class='input-xlarge' autofocus='true' style='width:140px;' /></td><td><input type='text' maxlength='50' value='"+pvProrate+"' class='input-xlarge' autofocus='true' style='width:140px;' /></td><td><a href='javascript:delProrateRow("+currentId+");'>删除</a></td><td>&nbsp;</td></tr>";
