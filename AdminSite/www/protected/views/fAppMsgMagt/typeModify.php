		...
		<div class="tab-pane active in" id="home">
			<form id="tab" method="post" action="">
				<table class="tableApp" style="width:815px;">
					...
					<tr>
						<td style="width:120px;">类型ID</td>
						<td><input type="text" maxlength="50" name="channelId"   value="<?php echo $TypeId;?>" class="input-xlarge" required="true" autofocus="true"  readonly /></td>
					</tr>
					<tr>
						<td>类型名称*</td>
						<td><input type="text" maxlength="50" name="typeName" value="<?php echo $typeName;?>"  class="input-xlarge" autofocus="true" required="true" /></td>
					</tr>
				</table>
