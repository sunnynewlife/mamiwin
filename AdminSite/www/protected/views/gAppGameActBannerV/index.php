<div class="btn-toolbar">
	<a href="/gAppGameActBannerV/add?os_type=<?php echo Yii::app()->request->getParam('os_type',1);?>&banner_type=<?php echo Yii::app()->request->getParam('banner_type',1);?>&in_version=<?php echo Yii::app()->request->getParam('in_version','2.0');?>" class="btn btn-primary"><i class="icon-plus"></i>增加banner配置</a>
	<a data-toggle="collapse" data-target="#search"  href="#" title= "检索"><button class="btn btn-primary" style="margin-left:5px"><i class="icon-search"></i></button></a>	
</div>
<div id="search" >
<form class="form_search"  action="/gAppGameActBannerV/index?os_type=<?php echo Yii::app()->request->getParam('os_type',1);?>" method="GET" style="margin-bottom:0px">
...
<div class="block">
	<a href="#page-stats" class="block-heading" data-toggle="collapse">管理<?php echo Yii::app()->request->getParam('os_type',1)==1?"Android":"iOS";?><?php echo Yii::app()->request->getParam('banner_type',1)==1?"游戏详情页->特权":"游戏推荐";?>页面轮播图</a>
...
<tr>
	...
	<td>%s</td>
	<td>
		<a href="/gAppGameActBannerV/modify?id=%s" title="修改"><i class="icon-pencil"></i></a>&nbsp;
		<a data-toggle="modal" href="#myModal" title="删除"><i class="icon-remove" href="/gAppGameActBannerV/del?id=%s"></i></a>
	</td>
<tr>
EndOfRowTag;
				$os_type=Yii::app()->request->getParam('os_type',1);
