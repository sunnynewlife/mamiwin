			...
			<form id="tab" method="post" action="" onsubmit="return checkSubmit();">
				<table class="tableApp" style="width:815px;">
					<tr>
						...
						<td><input type="text" maxlength="50" name="AppName" id="AppName" value="" class="input-xlarge" required="true" autofocus="true" /></td>
						<td style="width:100px;">游戏APPID*</td>
						<td><input type="text" maxlength="50" name="AppId"  id="AppId" value="" class="input-xlarge" required="true" autofocus="true" /></td>
					</tr>
					<tr>
						<td>开发商</td>
						<td><input type="text" maxlength="50" name="Developer" value="" class="input-xlarge" autofocus="true" /></td>
						<td>运营商</td>
						<td><input type="text" maxlength="50" name="Publisher" value="" class="input-xlarge" autofocus="true" /></td>
					</tr>
					<tr>
						<td>游戏类型*</td>
						<td>
							...
							foreach ($game_type as $item){
								echo sprintf("<option value=\"%s\" >%s</option>",$item["code"],$item["name"]);
							} 
							?>
							</select>	
						</td>
...
<?php
								foreach ($game_data_index as $itemKey => $itemValue){
									echo sprintf("<option value=\"%s\">%s</option>",$itemKey,$itemValue);
								} 
?>							
							</select>
						</td>
...
<?php
								foreach ($game_tag as $keyLabel){
									echo sprintf("<option value=\"%s\">%s</option>",$keyLabel,$keyLabel);
								} 
?>									
							</select>
...
?>																	
					...
					<tr>
						<td>游戏截图*</td>
						<td><input type="text" maxlength="50" name="GamePics" value="" id="GamePics" onclick="javascript:selectPics('GamePics',true);" class="input-xlarge" autofocus="true" required="true" /></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>游戏概述*</td>
						<td colspan="3"><textarea id="AppIntroduct" maxlength="300" name="AppIntroduct" rows="4" style="width:600px;" class="input-xlarge" required="true" autofocus="true"></textarea></td>
					</tr>
					<tr>
						<td>游戏详情*</td>
						<td colspan="3"><textarea id="AppDetail" maxlength="2000" name="AppDetail" rows="8" style="width:600px;" class="input-xlarge" required="true" autofocus="true"></textarea></td>
					</tr>
					<tr>
						<td>打包时提示</td>
						<td colspan="3"><textarea id="PromptTitle" maxlength="100" name="PromptTitle" rows="1" style="width:600px;" class="input-xlarge" autofocus="true"></textarea></td>
					</tr>
					<tr>
						<td>打包文件名前缀*</td>
						<td><input type="text" maxlength="50" name="PackagePrefixName" value=""  class="input-xlarge" autofocus="true" required="true" /></td>
						<td colspan=2><font color=red>英文字符，不含有其他字符和符号</font></td>
					</tr>
					<tr>
						<td>打包游戏名*(英文)</td>
						<td><input type="text" maxlength="50" name="AppNameEn" value=""  class="input-xlarge" autofocus="true" required="true" /></td>
						<td colspan=2><font color=red>英文字符，不含有其他字符和符号</font></td>
					</tr>
					...
					<tr>
						<td>红利信息*</td>
						<td colspan="3"><input type="text" maxlength="200" name="ProfitUrl" value="" class="input-xlarge" autofocus="true" required="true" style="width:600px;" /></td>
					</tr>
					<tr>
						<td>游戏活动地址</td>
						<td colspan="3"><input type="text" maxlength="200" name="EventUrl" value="" class="input-xlarge" autofocus="true"  style="width:600px;" /></td>
					</tr>
					<tr>
						<td>开发商分成比例*</td>
						<td><input type="text" maxlength="50" id="DeveloperProrate" name="DeveloperProrate" value="" class="input-xlarge" autofocus="true" required="true" /></td>
						<td><font color=red>值在1-100之间</font></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>成本费率*</td>
						<td><input type="text" maxlength="50" name="CostFeePercent" value="" class="input-small" autofocus="true" required="true" /></td>
						<td colspan=2><font color=red>数值。如:0.015 表示1.5%成本。开发商在此费率扣除后计算分成</font></td>
					</tr>
					<tr>
						<td>排列顺序*</td>
						<td><input type="text" maxlength="50" name="SortIndex" value="" class="input-small" autofocus="true" required="true" /></td>
						<td colspan=2><font color=red>值为数字,值小排列在前面</font></td>
					</tr>
					<tr>
						<td>游戏自动打包阀值*</td>
						<td><input type="text" maxlength="50" name="MinPackingPoolSize" value="" class="input-xLarge" autofocus="true" required="true" /></td>
				...
				<table class="tableApp" style="width:815px;">
					<tr>
						...
						<td><input type="text" maxlength="50" name="WeixinTitle" value="" class="input-xlarge" required="true" autofocus="true" /></td>
						<td style="width:120px;">微信分享-图片</td>
						<td><input type="text" maxlength="50" name="WeixinPic" id="WeixinPic" value="" class="input-xlarge" required="true" autofocus="true" onclick="javascript:selectPics('WeixinPic',false)" /></td>
					</tr>
					<tr>
						<td>微信分享-内容</td>
						<td colspan=3><textarea id="WeixinContent" maxlength="300" name="WeixinContent" rows="3" style="width:600px;" class="input-xlarge" required="true" autofocus="true"></textarea></td>
					</tr>
					<tr>
						<td>微博分享-文字</td>
						<td colspan=3><textarea id="WeiBoContent" maxlength="300" name="WeiBoContent" rows="3" style="width:600px;" class="input-xlarge" required="true" autofocus="true"></textarea></td>
					</tr>
					<tr>
						<td>微博分享-图片</td>
						<td colspan=3><input type="text" maxlength="50" name="WeiBoPic" id="WeiBoPic" onclick="javascript:selectPics('WeiBoPic',false);" value="" class="input-xlarge" required="true" autofocus="true" /></td>
					</tr>
					<tr>
						<td>短信分享-文字</td>
						<td colspan=3><textarea id="PhoneMsg" maxlength="300" name="PhoneMsg" rows="3" style="width:600px;" class="input-xlarge" required="true" autofocus="true"></textarea></td>
					</tr>
				</table>
