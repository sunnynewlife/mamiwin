<div class="btn-toolbar">
	<a href="/gAppGameConfigs/add" class="btn btn-primary"><i class="icon-plus"></i>增加配置定义</a>
...
<div class="block">
	<a href="#page-stats" class="block-heading" data-toggle="collapse">配置定义定义列表</a>
...
<tr>
	...
	<td>%s</td>
	<td>
		<a href="/gAppGameConfigs/modify?id=%s" title="修改"><i class="icon-pencil"></i></a>&nbsp;
		<a data-toggle="modal" href="#myModal" title="删除"><i class="icon-remove" href="/gAppGameConfigs/del?id=%s"></i></a>
	</td>
<tr>
EndOfRowTag;
				$sql="select gameid,game_name from t_game_config;";
