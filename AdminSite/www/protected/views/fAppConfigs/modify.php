	...
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane active in" id="home">
			<form id="tab" method="post" action="">
				<label>配置项Key</label> 
				<input type="text" maxlength="50" name="ConfigKey" value="<?php echo $SystemConfig["ConfigKey"];?>" class="input-xlarge" required="true" autofocus="true" />
				
				<label>配置项描述</label> 
				<input type="text" maxlength="100" name="ConfigName" value="<?php echo $SystemConfig["ConfigName"];?>" class="input-xlarge" required="true" autofocus="true" />
				

<?php
	$isJsonFormat=false;
	$jsonObject=json_decode($SystemConfig["ConfigValue"]);
...
?>				
				...
				<textarea id="ConfigValue" maxlength="15000" name="ConfigValue" rows="8" style="width:800px;" class="input-xlarge" required="true" autofocus="true"><?php echo $SystemConfig["ConfigValue"];?></textarea>
