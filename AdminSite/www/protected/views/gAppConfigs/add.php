	...
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane active in" id="home">
			<form id="tab" method="post" action="">
				<label>配置项名称</label> 
				<input  name="config_key" rows="5" class="input-xlarge" required="true" autofocus="true" value=""/>
				<br/>
				<br/>
				...
				<textarea id="config_value" name="config_value" rows="8" style="width:800px;" class="input-xlarge" required="true" autofocus="true"></textarea>
