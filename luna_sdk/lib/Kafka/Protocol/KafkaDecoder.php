...
class KafkaDecoder extends KafkaProtocol
{
    // {{{ functions
    ...
    public function produceResponse()
    {
        ...
        if (!$dataLen) {
            throw new KafkaExceptionProtocol('produce response invalid.');
        }
    ...
    public function fetchResponse()
    {
        return new KafkaTopic($this->stream);
    }
    ...
    public function metadataResponse()
    {
        ...
        $dataLen = array_shift($dataLen);
        if (!$dataLen) {
            throw new KafkaExceptionProtocol('metaData response invalid.');
        }
        $data = $this->stream->read($dataLen, true);
        $offset = 4;
    ...
    public function offsetResponse()
    {
        ...
        $dataLen = array_shift($dataLen);
        if (!$dataLen) {
            throw new KafkaExceptionProtocol('offset response invalid.');
        }
        $data = $this->stream->read($dataLen, true);
        $offset = 4;
        $topicCount = self::unpack(self::BIT_B32, substr($data, $offset, 4));
    ...
    public function commitOffsetResponse()
    {
        ...
        $dataLen = array_shift($dataLen);
        if (!$dataLen) {
            throw new KafkaExceptionProtocol('commit offset response invalid.');
        }
        $data = $this->stream->read($dataLen, true);
        $offset = 4;
        $topicCount = self::unpack(self::BIT_B32, substr($data, $offset, 4));
    ...
    public function fetchOffsetResponse()
    {
        ...
        $dataLen = array_shift($dataLen);
        if (!$dataLen) {
            throw new KafkaExceptionProtocol('fetch offset response invalid.');
        }
        $data = $this->stream->read($dataLen, true);
        $offset = 4;
        $topicCount = self::unpack(self::BIT_B32, substr($data, $offset, 4));
