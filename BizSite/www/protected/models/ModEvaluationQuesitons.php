...
class ModEvaluationQuesitons {
	...
	public function getEvaluationQuesitonsList($Question_Set_IDX = '',$pagesize = 10 ,$offSet = 0 ){
		...
		$params=array();
		$sql=" SELECT IDX,Question_Set_IDX,Question_Stems,Ability_Type_ID,Option_A,Option_B,Option_C,Option_D,Option_E,Option_F,Point_A,Point_B,Point_C,Point_D,Point_E,Point_F,Create_time,Update_time from Evaluation_Questions	where 1 = 1 ";
	...
	public function getEvaluationQuesitons($IDX){
		$params=array();
		$sql="SELECT IDX,Question_Set_IDX,Question_Stems,Ability_Type_ID,Option_A,Option_B,Option_C,Option_D,Option_E,Option_F,Point_A,Point_B,Point_C,Point_D,Point_E,Point_F,Create_time,Update_time from Evaluation_Questions where IDX = ? ";
